...
var dateString_array: Array<string> = []
var number_of_users_array: Array<number> = []
...
let kloak_user_data: Array<string|number> =[]
kloak_user_data = db.each(query, [], (totaluser:Totaluser) => {
